...
class TestGetServerInfo:
    ...
    def test_get_server_info_text_output(self, mock_print, mock_get_client, mock_splunk_client):
    ...
    def test_get_server_info_json_output(self, mock_format_json, mock_get_client, mock_splunk_client):
...
class TestGetServerStatus:
    ...
    def test_get_server_status_text_output(self, mock_print, mock_format, mock_get_client,
                                            mock_splunk_client, sample_server_status_response):
    ...
    def test_get_server_status_json_output(self, mock_format_json, mock_get_client,
                                            mock_splunk_client, sample_server_status_response):
...
class TestGetServerHealth:
    ...
    def test_get_server_health_text_output(self, mock_print, mock_format, mock_get_client,
                                            mock_splunk_client, sample_server_health_response):
    ...
    def test_get_server_health_json_output(self, mock_format_json, mock_get_client,
                                            mock_splunk_client, sample_server_health_response):
    ...
    @patch('get_server_health.format_table')
    @patch('get_server_health.print_success')
    def test_get_server_health_with_features(self, mock_print, mock_format, mock_get_client,
                                              mock_splunk_client, sample_server_health_response):
