...
@handle_errors
def main():
    parser = argparse.ArgumentParser(description='Get preview results from a running job')
    parser.add_argument('sid', help='Search job ID')
    parser.add_argument('--profile', '-p', help='Splunk profile to use')
    parser.add_argument('--count', '-c', type=int, default=100, help='Max preview results')
