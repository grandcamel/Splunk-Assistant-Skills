...
class TestListApps:
    ...
    def test_list_apps_text_output(self, mock_print, mock_format, mock_get_client,
                                    mock_splunk_client, sample_apps_response):
    ...
    def test_list_apps_json_output(self, mock_format_json, mock_get_client,
                                    mock_splunk_client, sample_apps_response):
...
class TestGetApp:
    ...
    def test_get_app_text_output(self, mock_print, mock_format, mock_get_client,
                                  mock_splunk_client, sample_single_app):
    ...
    def test_get_app_json_output(self, mock_format_json, mock_get_client,
                                  mock_splunk_client, sample_single_app):
...
class TestInstallApp:
    ...
    def test_install_app_from_file_with_force(self, mock_path, mock_print,
                                               mock_get_client, mock_splunk_client):
    ...
    @patch('install_app.Path')
    def test_install_app_cancelled(self, mock_path, mock_input, mock_warn,
                                    mock_get_client, mock_splunk_client):
    ...
    @patch('install_app.print_warning')
    @patch('install_app.Path')
    def test_install_app_invalid_source(self, mock_path, mock_warn,
                                         mock_get_client, mock_splunk_client):
