...
def main():
    ...
    parser.add_argument('--disable', action='store_true', help='Disable the saved search')
    parser.add_argument('--enable-schedule', action='store_true', help='Enable scheduling')
    parser.add_argument('--disable-schedule', action='store_true', help='Disable scheduling')
