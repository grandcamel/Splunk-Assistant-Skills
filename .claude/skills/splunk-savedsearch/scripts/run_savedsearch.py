...
def main():
    ...
    parser.add_argument('--timeout', '-t', type=int, default=300, help='Wait timeout in seconds (default: 300)')
    ...
    if args.wait and sid:
        ...
        while time.time() - start < args.timeout:
            ...
            if content.get('isDone'):
                print_success(f"Search completed. Results: {content.get('resultCount', 0)}")
            ...
            print_info(f"Timeout after {args.timeout}s. Job still running with SID: {sid}")
