...
class TestGetSavedsearch:
    ...
    def test_get_savedsearch_text_output(self, mock_print, mock_format, mock_get_client,
                                          mock_splunk_client, sample_single_savedsearch):
    ...
    def test_get_savedsearch_json_output(self, mock_format_json, mock_get_client,
                                          mock_splunk_client, sample_single_savedsearch):
        ...
        with patch('sys.argv', ['get_savedsearch.py', 'Daily Error Report', '--output', 'json']):
            main()
...
class TestCreateSavedsearch:
    ...
    def test_create_savedsearch_basic(self, mock_print, mock_get_client, mock_splunk_client):
        ...
        with patch('sys.argv', ['create_savedsearch.py', 'Test Search',
                                'index=main | head 10']):
            main()
    ...
    @patch('create_savedsearch.get_splunk_client')
    @patch('create_savedsearch.print_success')
    def test_create_savedsearch_scheduled(self, mock_print, mock_get_client, mock_splunk_client):
        ...
        with patch('sys.argv', ['create_savedsearch.py', 'Scheduled Search',
...
class TestUpdateSavedsearch:
    ...
    def test_update_savedsearch_search(self, mock_print, mock_get_client, mock_splunk_client):
        ...
        with patch('sys.argv', ['update_savedsearch.py', 'Test Search',
    ...
    @patch('update_savedsearch.get_splunk_client')
    @patch('update_savedsearch.print_success')
    def test_update_savedsearch_disable(self, mock_print, mock_get_client, mock_splunk_client):
...
class TestDeleteSavedsearch:
    ...
    def test_delete_savedsearch_with_force(self, mock_print, mock_get_client, mock_splunk_client):
    ...
    def test_delete_savedsearch_cancelled(self, mock_input, mock_warn, mock_get_client, mock_splunk_client):
...
class TestRunSavedsearch:
    ...
    def test_run_savedsearch_basic(self, mock_print, mock_get_client,
                                    mock_splunk_client, sample_dispatch_response):
    ...
    @patch('run_savedsearch.get_splunk_client')
    @patch('run_savedsearch.print_success')
    def test_run_savedsearch_with_time_range(self, mock_print, mock_get_client,
                                              mock_splunk_client, sample_dispatch_response):
