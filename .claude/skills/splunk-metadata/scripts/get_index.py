...
def main():
    ...
    response = client.get(f"/data/indexes/{args.name}", operation="get index")
    ...
    if args.output == "json":
        ...
        details = [
            ...
            {
                "Property": "Max Total Size (MB)",
                "Value": content.get("maxTotalDataSizeMB", "N/A"),
            },
            {
                "Property": "Frozen Time (sec)",
                "Value": content.get("frozenTimePeriodInSecs", "N/A"),
            },
            {
                "Property": "Total Event Count",
                "Value": content.get("totalEventCount", "N/A"),
            },
            {
                "Property": "Current Size (MB)",
                "Value": content.get("currentDBSizeMB", "N/A"),
            },
            {
                "Property": "Disabled",
