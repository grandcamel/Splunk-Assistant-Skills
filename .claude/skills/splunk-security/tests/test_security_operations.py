...
class TestGetCurrentUser:
    ...
    def test_get_current_user_text_output(self, mock_print, mock_format, mock_get_client,
                                           mock_splunk_client, sample_current_user_response):
    ...
    def test_get_current_user_json_output(self, mock_format_json, mock_get_client,
                                           mock_splunk_client, sample_current_user_response):
...
class TestListUsers:
    ...
    def test_list_users_text_output(self, mock_print, mock_format, mock_get_client,
                                     mock_splunk_client, sample_users_response):
    ...
    def test_list_users_json_output(self, mock_format_json, mock_get_client,
                                     mock_splunk_client, sample_users_response):
    ...
    @patch('list_users.format_table')
    @patch('list_users.print_success')
    def test_list_users_with_count(self, mock_print, mock_format, mock_get_client,
                                    mock_splunk_client, sample_users_response):
...
class TestListRoles:
    ...
    def test_list_roles_text_output(self, mock_print, mock_format, mock_get_client,
                                     mock_splunk_client, sample_roles_response):
    ...
    def test_list_roles_json_output(self, mock_format_json, mock_get_client,
                                     mock_splunk_client, sample_roles_response):
