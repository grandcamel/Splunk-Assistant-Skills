...
class TestCreateCollection:
    ...
    def test_create_collection_basic(self, mock_print, mock_get_client, mock_splunk_client):
    ...
    @patch('create_collection.get_splunk_client')
    @patch('create_collection.print_success')
    def test_create_collection_with_app(self, mock_print, mock_get_client, mock_splunk_client):
        ...
        with patch('sys.argv', ['create_collection.py', 'test_collection', '--app', 'myapp']):
            main()
    ...
    @patch('create_collection.get_splunk_client')
    @patch('create_collection.print_success')
    def test_create_collection_with_fields(self, mock_print, mock_get_client, mock_splunk_client):
    ...
    @patch('create_collection.get_splunk_client')
    @patch('create_collection.print_success')
    def test_create_collection_with_accelerated_fields(self, mock_print, mock_get_client, mock_splunk_client):
        ...
        with patch('sys.argv', ['create_collection.py', 'test_collection',
                                '--accelerated-fields', '{"idx1": {"name": 1}}']):
            main()
