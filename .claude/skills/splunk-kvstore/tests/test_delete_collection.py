...
class TestDeleteCollection:
    ...
    def test_delete_collection_with_force(self, mock_print, mock_get_client, mock_splunk_client):
    ...
    @patch('delete_collection.print_success')
    def test_delete_collection_with_confirmation(self, mock_print, mock_input,
    ...
    def test_delete_collection_cancelled(self, mock_input, mock_warn, mock_get_client, mock_splunk_client):
    ...
    @patch('delete_collection.get_splunk_client')
    @patch('delete_collection.print_success')
    def test_delete_collection_specific_app(self, mock_print, mock_get_client, mock_splunk_client):
        ...
        with patch('sys.argv', ['delete_collection.py', 'test_collection', '--app', 'myapp', '--force']):
            main()
