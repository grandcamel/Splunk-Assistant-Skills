...
class TestInsertRecord:
    ...
    def test_insert_record_basic(self, mock_print, mock_get_client, mock_splunk_client):
        ...
        with patch('sys.argv', ['insert_record.py', 'test_collection',
    ...
    @patch('insert_record.get_splunk_client')
    @patch('insert_record.print_success')
    def test_insert_record_with_key(self, mock_print, mock_get_client, mock_splunk_client):
...
class TestGetRecord:
    ...
    def test_get_record_basic(self, mock_print, mock_format_json, mock_get_client,
                               mock_splunk_client, sample_single_record):
    ...
    @patch('get_record.format_json')
    @patch('get_record.print_success')
    def test_get_record_specific_app(self, mock_print, mock_format_json, mock_get_client,
                                      mock_splunk_client, sample_single_record):
        ...
        with patch('sys.argv', ['get_record.py', 'test_collection', 'user1', '--app', 'myapp']):
            main()
...
class TestUpdateRecord:
    ...
    def test_update_record_basic(self, mock_print, mock_get_client, mock_splunk_client):
        ...
        with patch('sys.argv', ['update_record.py', 'test_collection', 'user1',
...
class TestDeleteRecord:
    ...
    @patch('delete_record.get_splunk_client')
    @patch('delete_record.print_success')
    def test_delete_record_specific_app(self, mock_print, mock_get_client, mock_splunk_client):
        ...
        with patch('sys.argv', ['delete_record.py', 'test_collection', 'user1', '--app', 'myapp']):
            main()
    ...
    @patch('delete_record.get_splunk_client')
    @patch('delete_record.print_success')
    def test_delete_record_with_profile(self, mock_print, mock_get_client, mock_splunk_client):
        ...
        with patch('sys.argv', ['delete_record.py', 'test_collection', 'user1', '--profile', 'prod']):
            main()
