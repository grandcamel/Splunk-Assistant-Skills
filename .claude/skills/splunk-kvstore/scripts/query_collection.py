...
def main():
    ...
    parser.add_argument('--filter', '-f', help='Query filter as JSON: {"field": "value"}')
    parser.add_argument('--fields', help='Comma-separated list of fields to return')
    parser.add_argument('--sort', '-s', help='Sort field (prefix with - for descending)')
    parser.add_argument('--limit', '-l', type=int, default=100, help='Max records (default: 100)')
