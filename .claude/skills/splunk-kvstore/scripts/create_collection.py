...
def main():
    ...
    parser.add_argument('--fields', '-f', help='Field definitions as JSON: {"field1": "string", "field2": "number"}')
    parser.add_argument('--accelerated-fields', help='Accelerated fields as JSON: {"index_name": {"field1": 1}}')
