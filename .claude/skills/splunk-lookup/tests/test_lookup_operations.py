...
class TestGetLookup:
    ...
    def test_get_lookup_text_output(self, mock_print, mock_format, mock_get_client,
                                     mock_splunk_client, sample_single_lookup):
    ...
    def test_get_lookup_json_output(self, mock_format_json, mock_get_client,
                                     mock_splunk_client, sample_single_lookup):
    ...
    @patch('get_lookup.format_table')
    @patch('get_lookup.print_success')
    def test_get_lookup_specific_app(self, mock_print, mock_format, mock_get_client,
                                      mock_splunk_client, sample_single_lookup):
...
class TestUploadLookup:
    ...
    def test_upload_lookup_basic(self, mock_path, mock_print, mock_get_client, mock_splunk_client):
...
class TestDownloadLookup:
    ...
    def test_download_lookup_basic(self, mock_print, mock_get_client, mock_splunk_client):
        ...
        with patch('sys.argv', ['download_lookup.py', 'users.csv', '--output', '/tmp/users.csv']):
            main()
...
class TestDeleteLookup:
    ...
    def test_delete_lookup_with_force(self, mock_print, mock_get_client, mock_splunk_client):
    ...
    @patch('delete_lookup.print_success')
    def test_delete_lookup_with_confirmation(self, mock_print, mock_input,
                                              mock_warn, mock_get_client, mock_splunk_client):
    ...
    def test_delete_lookup_cancelled(self, mock_input, mock_warn, mock_get_client, mock_splunk_client):
