...
Examples:
  ...
  python create_job.py "index=main" --exec-mode blocking
    ...
    parser.add_argument('--exec-mode', choices=['normal', 'blocking'], default='normal',
    ...
    response = client.post(
        '/search/v2/jobs',
        data=data,
        timeout=client.DEFAULT_SEARCH_TIMEOUT if args.exec_mode == 'blocking' else client.timeout,
