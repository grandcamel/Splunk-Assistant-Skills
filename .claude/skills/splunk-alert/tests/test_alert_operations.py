...
class TestListAlerts:
    ...
    def test_list_alerts_text_output(self, mock_print, mock_format, mock_get_client,
                                      mock_splunk_client, sample_alerts_response):
    ...
    def test_list_alerts_json_output(self, mock_format_json, mock_get_client,
                                      mock_splunk_client, sample_alerts_response):
    ...
    @patch('list_alerts.format_table')
    @patch('list_alerts.print_success')
    def test_list_alerts_with_severity_filter(self, mock_print, mock_format, mock_get_client,
                                               mock_splunk_client, sample_alerts_response):
...
class TestGetAlert:
    ...
    def test_get_alert_text_output(self, mock_print, mock_format, mock_get_client,
                                    mock_splunk_client, sample_single_alert):
    ...
    def test_get_alert_json_output(self, mock_format_json, mock_get_client,
                                    mock_splunk_client, sample_single_alert):
...
class TestAcknowledgeAlert:
    ...
    def test_acknowledge_alert_with_force(self, mock_print, mock_get_client, mock_splunk_client):
    ...
    @patch('acknowledge_alert.print_success')
    def test_acknowledge_alert_with_confirmation(self, mock_print, mock_input,
    ...
    def test_acknowledge_alert_cancelled(self, mock_input, mock_warn, mock_get_client, mock_splunk_client):
