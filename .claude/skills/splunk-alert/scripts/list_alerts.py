...
def main():
    ...
    parser.add_argument('--count', '-c', type=int, default=50, help='Max results (default: 50)')
    parser.add_argument('--severity', '-s', type=int, choices=[1, 2, 3, 4, 5, 6],
    ...
    if args.severity:
        entries = [e for e in entries if e.get('content', {}).get('severity', 0) == args.severity]
