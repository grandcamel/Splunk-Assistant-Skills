...
class TestCreateIndex:
    ...
    def test_create_index_metric(self, mock_print, mock_get_client, mock_splunk_client):
        ...
        with patch(
            "sys.argv", ["create_index.py", "metric_index", "--datatype", "metric"]
        ):
            main()
    ...
    @patch("create_index.get_splunk_client")
    @patch("create_index.print_success")
    def test_create_index_with_size_limit(
        ...
        with patch(
            "sys.argv", ["create_index.py", "sized_index", "--max-size-mb", "10000"]
        ):
            main()
...
class TestListSourcetypes:
    ...
    def test_list_sourcetypes_text_output(
        self,
        mock_print,
        mock_format,
        mock_get_client,
        mock_splunk_client,
        sample_sourcetypes_response,
    ):
    ...
    def test_list_sourcetypes_json_output(
        self,
        mock_format_json,
        mock_get_client,
        mock_splunk_client,
    ...
    @patch("list_sourcetypes.format_table")
    @patch("list_sourcetypes.print_success")
    def test_list_sourcetypes_with_index_filter(
        self,
        mock_print,
        mock_format,
        mock_get_client,
