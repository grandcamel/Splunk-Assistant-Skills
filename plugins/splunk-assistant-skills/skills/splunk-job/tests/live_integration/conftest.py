#!/usr/bin/env python3
"""
Pytest configuration for splunk-job live integration tests.
...
# Import all fixtures from shared module - DO NOT redefine session-scoped fixtures
# This ensures a single Splunk container is shared across all skill tests
